...
\begin{DoxyCompactList}\small\item\em the new threshold value \end{DoxyCompactList}\item 
void \hyperlink{class_image_widget_a279ebc2e3aab9adc8a29f671078d6a5a}{resize\+Event} (Q\+Resize\+Event $\ast$event)
\begin{DoxyCompactList}\small\item\em overrides the resize event to resize the picture \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hline
\end{DoxyParams}
\index{Image\+Widget@{Image\+Widget}!resize\+Event@{resize\+Event}}
\index{resize\+Event@{resize\+Event}!Image\+Widget@{Image\+Widget}}
\subsubsection[{\texorpdfstring{resize\+Event(\+Q\+Resize\+Event $\ast$event)}{resizeEvent(QResizeEvent *event)}}]{\setlength{\rightskip}{0pt plus 5cm}void Image\+Widget\+::resize\+Event (
\begin{DoxyParamCaption}
\item[{Q\+Resize\+Event $\ast$}]{event}
\end{DoxyParamCaption}
)}\hypertarget{class_image_widget_a279ebc2e3aab9adc8a29f671078d6a5a}{}\label{class_image_widget_a279ebc2e3aab9adc8a29f671078d6a5a}


overrides the resize event to resize the picture 


\begin{DoxyParams}{Parameters}
{\em event} & event for qt resize \\
\hline
\end{DoxyParams}
